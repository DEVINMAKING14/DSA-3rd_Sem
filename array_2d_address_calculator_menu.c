...
int main(){
    ...
    int option,elementSize,rowIndex,columnIndex,lowestColumn,lowestRow,rowCount,columnCount;
    int *baseAddress = &matrix[0][0];
    elementSize = sizeof(int);
    columnCount = sizeof(matrix[0])/sizeof(matrix[0][0]);
    rowCount = sizeof(matrix)/sizeof(matrix[0]);
    char again = 'y';
    do{
        options();
